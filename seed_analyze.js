...
mongoose.connection.on('open', function() {
    mongoose.connection.db.dropDatabase(function() {
        ...
        async.each(Object.keys(data), // [HOTEL, REST, THING]
            function(modelName, /*(e.g. HOTEL)*/ outerDone) {
                async.each(data[/*HOTEL*/], /*[{obj1}, {obj2}]*/
                    function(d /*doc*/, innerDone) {
                        models[/*HOTEL*/].create(/*doc*/, innerDone);
                    },
                    outerDone
                );
            },
